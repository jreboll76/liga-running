...
def remove_black_background(input_path, output_path, threshold=80):
    ...
    for item in datas:
        ...
        # Use a more aggressive approach: if all channels are low, it's likely part of the background
    ...
    print(f"Success: Saved transparent PNG with threshold {threshold} to {output_path}")
